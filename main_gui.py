...
class Application(tk.Frame):
    ...
    def createWidgets(self):
        self.imInput = Entry(self, width = 50, font = (FONT, 12))
        ...
        self.plotButton = tk.Button(self)
        ...
        self.turtleSheet.setworldcoordinates(0, 0, im2glib.config.imdim,\
                                   im2glib.config.imdim)
        ...
        self.serialButton = tk.Button(self)
    ...
    def plot(self):
        ...
        if self.paths == []: self.paths = im2glib.imToPaths(self.filename)
    ...
    def toText(self):
        ...
        im2glib.toTextFile(outfile, self.paths)
    
    def toSerial(self):
        self.filename = self.imInput.get()
        if self.paths == []: self.paths = im2glib.imToPaths(self.filename)
        
        im2glib.toSerial(self.paths)
